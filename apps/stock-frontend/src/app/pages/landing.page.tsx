...
import { StockInformationModal } from "../components/stockinformation.modal.component";
import { HomeOutlined, StockOutlined } from '@ant-design/icons';
import { FloatButton, Breadcrumb, Typography } from "antd";

const { Link } = Typography;

export function Landing() {
	const [selectedStockData, setSelectedStockData] = useState<StockItem>();

	const onSearchClickHandler = async (enteredData: StockItem) => {
		try {
	...
	return (
		<>
			...
			<div className="wrapper">
				...
				<StockInformationModal selectedStock={selectedStockData} />
				<div className="container">
					<StockSearch onSearchClicked={onSearchClickHandler} />
				</div>
				<FloatButton
					href="/portfolio"
					icon={<StockOutlined />}
